                    ...
                    <div class="book_columns">
                        ...
                        while ( $posts->have_posts() && $post_count < 3 ) : $posts->the_post();
                            ...
                            <div class="book_column">
                                ...
                                $post_id = rwmb_meta( 'book_author_name' );
                                ?>
                                <p class="book_author_relation"><?= get_the_title( $post_id ); ?></p>
                            </div>
                        <?php endwhile; ?>
                    </div>
